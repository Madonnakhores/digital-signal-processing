...
0.949263346546471f,
        ...
        public void CrossDirectNonNormalizedNonPeriodicCorrelationTestMethod1()
        {
            ...
            fc.InputSignal1 = new Signal(new List<float>() { 4, 3, 1, 6,0,0 }, false);
            fc.InputSignal2 = new Signal(new List<float>() { 5, 2, 3,0,0,0}, false);
        ...
        public void CrossDirectNonNormalizedPeriodicCorrelationTestMethod1()
        {
            ...
            fc.InputSignal1 = new Signal(new List<float>() { 4, 3, 1, 6,0,0 }, true);
            fc.InputSignal2 = new Signal(new List<float>() { 5, 2, 3,0 ,0,0}, true);
        ...
        public void CrossDirectNonNormalizedNonPeriodicCorrelationTestMethod2()
        {
            ...
            fc.InputSignal1 = new Signal(new List<float>() { 2, 1 , 0, 0, 3,0,0 }, false);
            fc.InputSignal2 = new Signal(new List<float>() { 2, 1, 4,0,0,0,0 }, false);
        ...
        public void CrossDirectNonNormalizedPeriodicCorrelationTestMethod2()
        {
            ...
            fc.InputSignal1 = new Signal(new List<float>() { 2, 1, 0, 0, 3,0,0 }, true);
            fc.InputSignal2 = new Signal(new List<float>() { 2, 1, 4 ,0,0,0,0}, true); 
        ...
        public void CrossDirectNormalizedNonPeriodicCorrelationTestMethod2()
        {
            ...
            fc.InputSignal1 = new Signal(new List<float>() { 2, 1, 0, 0, 3,0,0 }, false);
            fc.InputSignal2 = new Signal(new List<float>() { 2, 1, 4,0,0,0,0 }, false); fc.Run();
